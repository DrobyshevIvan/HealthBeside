...
namespace HealthBeside.API.Controllers
{
    ...
    public class ForumPostController : ControllerBase
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var posts = await _forumPostService.GetAllAsync(cancellationToken);
            return Ok(posts);
        }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var post = await _forumPostService.GetByIdAsync(id, cancellationToken);
                return Ok(post);
            }
            catch (Exception ex)
            {
        ...
        [Authorize]
        public async Task<ActionResult<GetDetailedForumPostDto>> PublishForumPost
        ([FromBody] CreateForumPostDto createDto,
            CancellationToken cancellationToken = default)
        {
        ...
        [HttpPut("update-post")]
        public async Task<IActionResult> UpdateForumPost
        ([FromBody] UpdateForumPostDto request,
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var result = await _forumPostService.UpdateAsync(request, userId, cancellationToken);
                return Ok(result);
            }
            ...
            {
                _logger.LogWarning("Validation failed while updating post {PostId}: {Message}", request.PostId,
                    ex.Message);
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var result = await _forumPostService.DeleteAsync(request.PostId, userId, cancellationToken);
